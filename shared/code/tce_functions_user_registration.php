...
function F_send_user_reg_email($user_id, $user_email, $user_verifycode) {
	...
	$mail->Subject = "Reset Password For GATExcel-135";
    $message = "<h4>GATExcel-135</h4>";
    $message.= "<p>Please click on the link to reset password click <a href = " . $subscribe_url .">HERE</a>";
    $message.= "<p> Thank you, <br> Ravindrababu Ravula</p>";
